...
> **Reusable for external discovery agents (Caitlin Brain etc.).** The council pattern (5 independent lenses + anonymous peer review + chairman synthesis) is the direct implementation template for Generator + Critic/Validator loops. See PROJECT_CHARTER.md ADR-001. Reuse with attribution.
